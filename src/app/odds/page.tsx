...
export const metadata = {
  title: 'Odds Board | Compare Lines Across Sportsbooks - BetAnalytics.ai',
  description: 'Compare live odds across DraftKings, FanDuel, BetMGM, Caesars, and more. Find the best price for every bet with our real-time odds comparison board.',
  alternates: {
    canonical: 'https://betanalytics.ai/odds',
  },
  openGraph: {
    title: 'Odds Board | Compare Lines Across Sportsbooks - BetAnalytics.ai',
    description: 'Real-time odds comparison across all major sportsbooks. Find the best price for moneylines, spreads, and totals.',
    url: 'https://betanalytics.ai/odds',
        ...
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="mb-8">
            ...
            <p className="text-lg text-slate-300 max-w-2xl">
              Compare live odds across every major sportsbook. Find the best price for every bet — 
              moneylines, spreads, and totals. Best available prices are highlighted in green.
            </p>
          </div>
          ...
          <div className="mt-12 bg-gradient-to-br from-blue-900/20 to-cyan-900/20 border border-blue-500/30 rounded-2xl p-8 text-center">
            <h2 className="text-2xl font-bold mb-3">Get AI-Powered Picks</h2>
            <p className="text-slate-300 mb-6 max-w-lg mx-auto">
              Don&apos;t just compare odds — let our Elo model tell you which bets have real edge.
              Get personalized recommendations with the best price at the best book.
            </p>
            <Link
              href="/signup"
